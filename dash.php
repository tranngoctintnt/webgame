      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=4">Add Game</a></li>
            <li><a href="dash.php?q=5">Remove Game</a></li>
...
<tr><td><b>STT</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
$c=1;
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Full Name</b></td></td><td><b>Username</b></td><td><b>Mark</b></td></tr>';
$c=0;
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>STT</b></td><td><b>FullName</b></td><td><b>Gender</b></td><td><b>Username</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>STT</b></td><td><b>Subject</b></td><td><b>Email</b></td><td><b>Date</b></td><td><b>Time</b></td><td><b>By</b></td><td></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$date = $row['date'];
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Game Details</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter Game title" class="form-control input-md" type="text">
